...
1. User enters a source folder and runs SyncSnap
2. If no source path is passed, SyncSnap asks which action to run
...
SyncSnap uses environment-based configuration.
...
FILENAME_PREFIX=zSyncSnapTestFolder2026May
HASH_LENGTH=12
